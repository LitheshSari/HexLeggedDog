...
controller_interface::CallbackReturn LegPdController::on_init() {
  ...
  reference_interfaces_.resize(60);

  return CallbackReturn::SUCCESS;
}

controller_interface::InterfaceConfiguration
LegPdController::command_interface_configuration() const {
...
controller_interface::InterfaceConfiguration
LegPdController::state_interface_configuration() const {
  controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL,
                                                       {}};
...
LegPdController::update_reference_from_subscribers(
...
LegPdController::on_export_reference_interfaces() {
...
PLUGINLIB_EXPORT_CLASS(leg_pd_controller::LegPdController,
